    ...
    <div className="main-container">
      ...
      <div className="last-container">
        ...
        <div className="next-pre-btn">
          <button onClick={handlePage} type="button" className="pre-button">
            Previous
          </button>
          <p>-</p>
          <button
      ...
      <div className="stastics-container">{/* {transactions } */}</div>
      <div className="line">
        <hr />
      </div>
      <Stastics selectedMonth={selectedMonth} />
      <BarChartCom selectedMonth={selectedMonth} />
    </div>
  )
}
